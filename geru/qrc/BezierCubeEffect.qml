...
Effect {
    ...
    parameters: [
        Parameter { name: "ka";   value: Qt.vector3d( 0.6, 0.6, 0.6 ) },
    ...
    techniques: [
        Technique {
            ...
            parameters: [
                Parameter { name: "light[0].position"; value: Qt.vector4d( 0.0, 0.0, 0.0, 1.0 ) },
                Parameter { name: "light[0].intensity"; value: Qt.vector3d( 1.0, 1.0, 1.0 ) },
				Parameter { name: "light[1].position"; value: Qt.vector4d( 0.0, 0.0, 0.0, 1.0 ) },
                Parameter { name: "light[1].intensity"; value: Qt.vector3d( 1.0, 1.0, 1.0 ) },
